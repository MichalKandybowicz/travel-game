...
export const TOKEN_DEFINITIONS: readonly TokenDefinition[] = [
  { type: 'GREEN_1', effect: { kind: 'MOVEMENT', movementType: 'GREEN', value: 1 } },
  { type: 'GREEN_2', effect: { kind: 'MOVEMENT', movementType: 'GREEN', value: 2 } },
  { type: 'BLUE_1', effect: { kind: 'MOVEMENT', movementType: 'BLUE', value: 1 } },
  { type: 'BLUE_2', effect: { kind: 'MOVEMENT', movementType: 'BLUE', value: 2 } },
  { type: 'YELLOW_1', effect: { kind: 'MOVEMENT', movementType: 'YELLOW', value: 1 } },
  { type: 'YELLOW_2', effect: { kind: 'MOVEMENT', movementType: 'YELLOW', value: 2 } },
  { type: 'WILD_1', effect: { kind: 'MOVEMENT', movementType: 'WILD', value: 1 } },
  { type: 'WILD_2', effect: { kind: 'MOVEMENT', movementType: 'WILD', value: 2 } },
